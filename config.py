...
# gpt-image-2: obsługuje dowolny rozmiar
# 4K = generuj jako 2K natywnie + Real-ESRGAN x2
...
# Cennik za 1 obraz USD (przybliżony)
...
def get_size(aspect: str, resolution: str) -> str:
    native = native_resolution(resolution)
    w, h = SIZE_MAP[(aspect, native)]
    return f"{w}x{h}"


def get_secret(name: str, default: str = "") -> str:
    """session_state → env var → Streamlit secrets."""
    try:
